...
export class ProjectServiceService {
  ...
  projects: Project[] = [
    {id: 0, name: 'Sample Angular portfolio', summary: 'Angular 17 based personal portfolio website', description: 'This project has been developed using Angular 17 and deployed on Github Pages. This project describes my current and past projects and the skillset I have gained.', projectLink: 'https://github.com/Aritra93/test-angular-app', tags: [Tag.ANGULAR, Tag.TYPESCRIPT], pictures: []},
    {id: 1, name: 'Sample Python API repository', summary: 'Rest API using Python and Flask', description: 'This project develops custom APIs using Python and Flask web framework. Some of the APIs developed are consumed by Angular 17 portfolio project. The APIs are hosted on Render.', projectLink: 'https://github.com/Aritra93/pyhton-api-respository', tags: [Tag.PYTHON, Tag.FLASK], pictures: []},
