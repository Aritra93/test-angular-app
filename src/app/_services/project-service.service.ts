...
export class ProjectServiceService {
  ...
  projects: Project[] = [
    ...
    {id: 1, name: 'Sample Python API project', summary: 'Rest API using python', description: 'lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum', projectLink: '//www.github.com', tags: [Tag.PYTHON], pictures: []},
